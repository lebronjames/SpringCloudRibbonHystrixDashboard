...
增加断路器Hystrix(spring-cloud-starter-hystrix)、Dashboard(spring-cloud-starter-hystrix-dashboard).
...
http://10.5.2.241:3733/add

Hystrix Dashborad访问地址：
http://localhost:3733/hystrix
